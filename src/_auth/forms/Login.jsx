...
const Login = () => {
  ...
  return (
    <div className="m-auto bg-white mt-20 border border-gray-200 rounded-xl shadow-2xs w-full max-w-100">
    <div className="p-4 sm:p-7">
      ...
      <div className="mt-5">
        ...
        <form>
          ...
          <PrimaryInput name="email" type="text" placeholder="email" label="Email address" />
          <PrimaryInput name="password" type="text" placeholder="password" label="Password" />  
            ...
            <PrimaryButton onClick={handleLogin} text="Sign in" type="button" />
          </div>
        </form>
        {/* End Form */}
      </div>
