      ...
      <div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-1 before:transform before:-translate-x-1/2">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            ...
            Bluehaven is a rewards-driven referral platform that empowers users to earn benefits by inviting others. Members unlock badges, level up their status, and receive exclusive rewards as they grow their network and contribute to the community.
            </p>
          </div>
      ...
      <div className="max-w-[85rem] bg-gray-50 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="lg:w-3/4">
            ...
            Collaborative tools that help businesses create better engagement and rewarding user experiences.
            </h2>
            <p className="mt-3 text-gray-800">
            We help businesses grow faster in the digital world by building powerful referral and reward systems that turn customers into loyal advocates and brand ambassadors.
            </p>
            <p className="mt-5">
              <a
